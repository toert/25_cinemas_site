...
class Film(db.Model):
    ...
    original_lang_name = db.Column(db.String(80))
    mpaa_rating = db.Column(db.String(80))
    description = db.Column(db.Text)
    genre = db.Column(db.String(80))
    image_url = db.Column(db.String(80))
    small_image_url = db.Column(db.String(80))
...
def create_new_film_class(dict_film_info):
    new_film = Film()
    new_film.original_lang_name = dict_film_info['original_lang_name']
    ...
    new_film.small_image_url = dict_film_info['small_image_url']
...
def get_info_about_film_from_db(film_id):
    ...
    film_info = {'name': film.film_name,
                 ...
                 'original_lang_name': film.original_lang_name,
                 'genre': film.genre,
